{
    ...
    checkAndAct: (c) => {
        ...
        const entryPath = "/fraus/config/entryMonthly";
        const modules = ['/fraus/app/main', '/fraus/app/helper', '/fraus/app/appMethods']; // add all of your modules with methods you want to be able to call anywhere here
