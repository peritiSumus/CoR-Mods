{
    ...
    checkAndAct: (c)=>{
        ...
        const entryPath = "/MOD_PATH/config/entryMonthly";
        const modules = ['/MOD_PATH/app/main', '/MOD_PATH/app/helper']; // add all of your modules with methods you want to be able to call anywhere here
